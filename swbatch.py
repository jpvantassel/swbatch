...
@click.option("--ellfnum", required=True, type=str, default=30, help="Number of frequency points in exported Rayleigh wave ellipticity curve(s). (30 is recommended)")
